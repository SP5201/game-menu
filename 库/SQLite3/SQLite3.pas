...
// Delphi translation of sqlite3.h 3.51.3 (2026-03-13)
// Source: https://github.com/stijnsanders/TSQLite (MIT)
// Legacy type aliases kept for SQLite3Wrap / LibraryStore.
...
type
  ...
  TSQLiteCArrayDataDestructor=procedure(aData:pointer); cdecl;

  { Legacy aliases for SQLite3Wrap / LibraryStore (plashenkov naming) }
  PSQLite3 = HSQLiteDB;
  PSQLite3Stmt = HSQLiteStatement;
  PSQLite3Value = HSQLiteValue;
  PSQLite3Context = HSQLiteContext;
  PSQLite3Blob = HSQLiteBlob;
  PSQLite3Mutex = HSQLiteMutex;
  PSQLite3Backup = HSQLiteBackup;
  TSQLite3DestructorType = TSQLiteDestructor;
  TSQLite3Callback = TSQLiteCallback;
  TSQLite3BusyCallback = TSQLiteBusyHandler;
  TSQLite3AuthorizerCallback = TSQLiteAuthorizer;
...
const
  ...
  SQLITE_ERROR_RESERVESIZE       = SQLITE_ERROR or $0400;
  SQLITE_ERROR_KEY               = SQLITE_ERROR or $0500;
  SQLITE_ERROR_UNABLE            = SQLITE_ERROR or $0600;
  ...
  SQLITE_IOERR_BADKEY            = SQLITE_IOERR or $2300;
  SQLITE_IOERR_CODEC             = SQLITE_IOERR or $2400;
...
function sqlite3_exec(SQLiteDB:HSQLiteDB;Sql:PAnsiChar;Callback:TSQLiteCallback;Context:pointer;
  ErrorMessage:PPAnsiChar):integer; cdecl;
...
function sqlite3_setlk_timeout(SQLiteDB:HSQLiteDB;ms,flags:integer):integer; cdecl;
...
function sqlite3_open(FileName:PAnsiChar;var SQLiteDB:PSQLite3):integer; cdecl;
function sqlite3_open16(FileName:PWideChar;var SQLiteDB:PSQLite3):integer; cdecl;
function sqlite3_open_v2(FileName:PAnsiChar;var SQLiteDB:PSQLite3;Flags:integer;VFSModule:PAnsiChar):integer; cdecl;
...
function sqlite3_set_errmsg(SQLiteDB:HSQLiteDB;errcode:integer;zErrMsg:PAnsiChar):integer; cdecl;
...
function sqlite3_prepare(SQLiteDB:HSQLiteDB;Sql:PAnsiChar;nByte:integer;
  var Statement:PSQLite3Stmt;pzTail:PPAnsiChar):integer; cdecl;
...
function sqlite3_bind_blob(Statement:HSQLiteStatement;Index:integer;zData:Pointer;N:integer;Z:TSQLiteDestructor):integer; cdecl;
...
function sqlite3_blob_open(SQLiteDB:HSQLiteDB;DB:PAnsiChar;TableName:PAnsiChar;ColumnName:PAnsiChar;Row:int64;Flags:integer;var Blob:PSQLite3Blob):integer; cdecl;
...
function sqlite3_db_status64(SQLiteDB:HSQLiteDB;Op:integer;var Current:int64;var HighWater:int64;ResetFlag:integer):integer; cdecl;
...
function sqlite3_carray_bind(pStmt:HSQLiteStatement;i:integer;aData:pointer;
  nData:integer;mFlags:integer;aDataDestructor:TSQLiteCArrayDataDestructor):
  integer; cdecl;
...
function sqlite3_setlk_timeout; external Sqlite3Dll {$IF DEFINED(DELAYED_DLL_LOAD)} delayed {$IFEND};
...
function sqlite3_set_errmsg; external Sqlite3Dll {$IF DEFINED(DELAYED_DLL_LOAD)} delayed {$IFEND};
...
function sqlite3_db_status64; external Sqlite3Dll {$IF DEFINED(DELAYED_DLL_LOAD)} delayed {$IFEND};
...
function sqlite3_carray_bind; external Sqlite3Dll {$IF DEFINED(DELAYED_DLL_LOAD)} delayed {$IFEND};
